"""Confluence page commands — get/create/update/move/delete via the REST API.

Uses the atlassian-python-api library (through lib/_client.confluence_client).
...
# From this file (…/skills/confluence-api/assets/pages.py) that's parents[3]/lib.
...
def add_parsers(sub):
    """Register the page subcommands on the shared subparsers object."""
